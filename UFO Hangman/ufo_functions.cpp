...
// Function to test if answer was found or if player lost
...
// Function to display incorrect and correct guesses
void display_status(std::vector <char> incorrect, std::string answer){
  
    // Display all the wrong letters
    std::cout << "\nincorrect Guesses: \n";
    for (int i = 0; i < incorrect.size(); i++){
      std::cout << incorrect[i] << " ";
    }

  // Display all of the correct guesses
    std::cout << "\nCodeword\n";
